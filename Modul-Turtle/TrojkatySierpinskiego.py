...
def sierpinski(zolwik, punkty, stopnie):
    ...
    rysuj_trojkat(
        zolwik, punkty, lista_kolorow[random.randint(0, len(lista_kolorow) - 1)]
    )
    if stopnie > 0:
        sierpinski(
            zolwik,
            (
                punkty[0],
                wyznacz_srodek(punkty[0], punkty[1]),
                wyznacz_srodek(punkty[0], punkty[2]),
            ),
            stopnie - 1,
        )
        sierpinski(
            ...
            (
                punkty[1],
                wyznacz_srodek(punkty[0], punkty[1]),
                wyznacz_srodek(punkty[1], punkty[2]),
            ),
            stopnie - 1,
        )
        sierpinski(
            ...
            (
                punkty[2],
                wyznacz_srodek(punkty[2], punkty[1]),
                wyznacz_srodek(punkty[0], punkty[2]),
            ),
            stopnie - 1,
        )
