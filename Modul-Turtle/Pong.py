...
class Dlugopis:
    ...
    def wypisz(self, punkty_A, punkty_B):
        self.zolwik.clear()
        self.zolwik.write(
            "Gracz A: {} Gracz B: {}".format(punkty_A, punkty_B),
            align="Center",
            font=("Arial", 30),
        )
...
class Pilka:
    ...
    def zderzenia(self):
        ...
        # paletki
        if (
            self.zolwik.xcor() < -430
            and abs(self.zolwik.ycor() - self.a.zolwik.ycor()) < 50
        ):
        ...
        if (
            self.zolwik.xcor() > 430
            and abs(self.zolwik.ycor() - self.b.zolwik.ycor()) < 50
        ):
            self.zolwik.goto(420, self.zolwik.ycor())
            self.dx *= -1
